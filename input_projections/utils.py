from input_projections.legendre_projection import LegendreProjection
...
def get_input_projection(input_projection_name, input_dim, output_dim, device, fourier_scale=10.0, legendre_max_degree=10, activation=F.relu):
    if input_projection_name == "legendre":
        return LegendreProjection(input_dim=input_dim, max_degree=legendre_max_degree, device=device)
